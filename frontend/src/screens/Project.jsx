...
const Project = ({navigate}) => {
    ...
    function appendIncomingMessage(messageObject){
        ...
        message.classList.add('message', 'mx-w-56', 'flex', 'flex-col', 'p-2', 'bg-slate-500', 'w-fit')
        message.innerHTML = `
    ...
    function appendOutgoingMessage(message){
        ...
        newMessage.classList.add('ml-auto', 'message', 'mx-w-56', 'flex', 'flex-col', 'p-2', 'bg-slate-500', 'w-fit')
