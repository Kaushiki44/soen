...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden">
            ...
            {/* Register card */}
            <div
                className="relative z-10 bg-gray-900/80 backdrop-blur-xl border border-indigo-900/40 rounded-2xl shadow-2xl shadow-indigo-950/60 w-full max-w-md mx-4 p-8"
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-gray-500 text-xs mt-1.5">Create your account to get started</p>
                </div>
